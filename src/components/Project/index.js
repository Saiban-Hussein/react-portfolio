...
function Project(props) {
	// function project is for importing the information for the current project sent down.
	...
	// finction  getTechs parses the information from the array and creates a list.
